...
% Can be uncommented in order to get a sliced plot 
...
rs=5; % distance de la source
pos_theta_deg=0; pos_theta_rad=deg2rad(pos_theta_deg); % Theta angle of the source
...
% titre=['300 Hz ';'800 Hz ';'1700 Hz';'4500 Hz'];
titre=['M=1';'M=1';'M=4';'M=5'];
...
axis tight
    ...
    title(titre(kk,:))
    var.cax=caxis;
    [~,hfigc] = contour(x1_vec,x1_vec,erreur_mat,[0 15]);
