function [ data_mat ,System,N,ct,t] = FrfSystemFinal_data_gui( data_mat,sweep_signal_vect,N,ct )
...
ct.dfe_sweep_avg=ct.Fs/N.N_sweep_avg;
...
h_fft_mat=zeros(N.N_sweep_avg,ct.N_mic,ct.N_sweep_avg);%initialisation
