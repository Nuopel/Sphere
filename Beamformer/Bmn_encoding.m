...
[ source.sweep, t, ct, N ] = GenSweep(0.01, ct.Fs/2,4.75, ct ) ;
source.sweep=repmat([source.sweep ],1,10);

source.sweep=0.7*source.sweep;
...
% end
audiowrite('sweep_signal_mic_sph.wav',source.sweep,ct.Fs)
