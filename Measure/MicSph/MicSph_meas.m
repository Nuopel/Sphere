...
[data.OutSig,ct.Fs_sca]=audioread('sph_hp51_calib.wav');
...
for ii=1:4
 subplot(2,2,ii)
ct.M=ii+1;
[Pressure.p_recons, ~ ] = Pressure_map_SphMic(ct.M,Bmn.recons(1:var.m_sum_vect(ii+2),1),ct,N,var,Antenna);title(sprintf('Reconstruction sphere mic calib %i-%i',var.select_freq,ii+1));
end
