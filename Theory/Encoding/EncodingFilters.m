...
% Bmn factor for encoding to show the singularities with open sphere
% Then compare the encoding Filter for open sphere and rigid sphere
...
xlabel('Frequency [Hz]');ylabel(' [dB] ref 1')
