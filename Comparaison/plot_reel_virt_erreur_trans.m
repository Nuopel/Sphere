function [] = plot_reel_virt_erreur_trans(h_sig,h_sig2,h_sig3,Antenna,ii,text,d )
...
subplot(313)
grid_mat_erreur=reshape(h_sig3,size(Antenna.X_mat));
...
subplot(311)
grid_mat=reshape(h_sig,size(Antenna.Y_mat));
...
subplot(312)
grid_mat=reshape(h_sig2,size(Antenna.Y_mat));
% surf(Antenna.y,Antenna.x,grid_mat); % plot of the frame
pcolor(Antenna.y,Antenna.x,grid_mat); % plot of the frame
